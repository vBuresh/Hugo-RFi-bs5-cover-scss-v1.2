---
title: Front Matter
subtitle: '- делает Hugo сильнее'
description: 'Front matter позволяет хранить метаданные, прикрепленные к экземпляру типа контента, то есть встроенные в файл контента.'
...
Front Matter является одной из многих функций, которые придают Hugo его силу.

Front matter позволяет хранить метаданные, прикрепленные к экземпляру типа контента, то есть встроенные в файл контента.
